...
print("Welcome to Go Fish Version 2.68a! This program simulates the game Go Fish in a computer model!")
...
def who_goes_first():
        ...
        if first_player == 1:
            ...
            if first_move == 2:
                ...
                print("You will ask Player 3 for a card.\n")   
            elif first_move == 4:
                print("You will ask player 4 for a card.\n")            
            else:
