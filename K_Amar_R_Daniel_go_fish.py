...
# Version 2.6 - Published 11/3/2016
...
print("Welcome to Go Fish-bot Version 2.5 . I am the best Go Fish simulator in the nation!")
...
deck = ["14", "13", "12", "11", "10", "9", "8", "7", "6", "5", "4", "3", "2", "14", "13", "12", "11", "10", "9", "8", "7", "6", "5", "4", "3", "2", "14", "13", "12", "11", "10", "9", "8", "7", "6", "5", "4", "3", "2", "14", "13", "12", "11", "10", "9", "8", "7", "6", "5", "4", "3", "2"]
shuffle(deck)
print (" The numbers 14, 13, 12, 11 are Ace, King, Queen, Jack in that order. If you would like to see what cards you have, just press enter. If an error shows, make sure you have the card and the card you are trying to get is not from yourself.") 
...
while 1:
    ...
    if player.startswith('AI_'):
        ...
        while 1: # Deals with what you input and what is you have
            ...
            if inp:
                ...
                print('Printing {}\'s hand in 5 seconds.'.format(player))
                time.sleep(5)
    ...
    if not success:
        ...
        print('{} got the {} from {}, and you get to go again.'.format(player, card, ask))
    if not success:
        idx += 1
        if idx >= len(names):
            idx = 0
