...
print("Welcome to Go Fish Version 1.53a! This program simulates the game Go Fish in a computer model!")
...
# Now let's make the program see who has the highest ranked card!         
...
#elif first_player == 0:
    #print ("Someone has the same card.")
    #if value[hand1[0]] == value[hand2[0]]:
        #print ("You got the same card as Player #2. We'll decide it randomly who gets to go first.")
        #chooser = print(randint(0,1))
        #if chooser == 0:
              # print ("Our random generator will let you go first instead of Player #2!")
        #elif chooser == 1:
            ##print ("Our random generator chose Player #2 to go first!")
        #else:
         #   print ("We'll let you go first because our random generator goofed up!")
         #   first_player = 1
...
if first_player == 1:
    ...
    if first_move == 2:
        print("What card do you want to ask Player #2 for?\n")
